...
namespace GenericInventorySystem.Forms
{
    public partial class AddCustomerForm : BaseModalForm
    {
        ...
        {
            InitializeComponent();
            this.TitleText = "Add New Customer";
            ApplyTheme();
        ...
        private void ApplyLocalization()
        {
            ...
            if(btnSave != null) btnSave.Text = isEdit ? L("AddCust_UpdateBtn") : L("AddCust_Save");
        }

        // Edit Mode Constructor
        public AddCustomerForm(int id, string name, string phone, string email, string address, string type) : this()
        {
            this.TitleText = "Edit Customer";
        ...
        private void InitializeComponent()
        {
            ...
            txtEmail.LabelText = "Email Address";
